function data_out = depermuter_ac(data_in, Ncbps, Nbpsc)
%DEPERMUTER Summary of this function goes here
...
data_out_0 = data_in_0(perm2);
data_out_0 = data_out_0(perm1);

data_out_1 = data_in_1(perm2);
data_out_1 = data_out_1(perm1);
